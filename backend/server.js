...
// CORS handler - must be absolutely first, before helmet and rate limiters
// Manually set headers to guarantee preflight always succeeds with credentials
app.use((req, res, next) => {
    const origin = req.headers.origin;
    // Reflect the exact requesting origin back (required for credentials: include)
    if (origin) {
